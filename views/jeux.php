...
<body>
    ...
    <div id=container>
        ...
        <div id="listGame"> <!--List game-->
            ...
            <div>
                <div><a href="./descriptionJeu.php"><img src="https://picsum.photos/150/200?random=1" alt="image du jeu" class="sizeup"></a></div>
                <article>
                    <div>
                        <a href="./descriptionJeu.php"><h3>Titre du jeu</h3></a>
            ...
            <div>
                <div><a href="./descriptionJeu.php"><img src="https://picsum.photos/150/200?random=2" alt="image du jeu" class="sizeup"></a></div>
                <article>
                    <div>
                        <a href="./descriptionJeu.php"><h3>Titre du jeu</h3></a>
                        <a href="#" class="sizeup">Ajouter à votre liste</a>
            ...
            <div>
                <div><a href="./descriptionJeu.php"><img src="https://picsum.photos/150/200?random=3" alt="image du jeu" class="sizeup"></a></div>
                <article>
                    <div>
                        <a href="./descriptionJeu.php"><h3>Titre du jeu</h3></a>
                        <a href="#" class="sizeup">Ajouter à votre liste</a>
            ...
            <div>
                <div><a href="./descriptionJeu.php"><img src="https://picsum.photos/150/200?random=4" alt="image du jeu" class="sizeup"></a></div>
                <article>
                    <div>
                        <a href="./descriptionJeu.php"><h3>Titre du jeu</h3></a>
                        <a href="#" class="sizeup">Ajouter à votre liste</a>
            ...
            <div>
                <div><a href="./descriptionJeu.php"><img src="https://picsum.photos/150/200?random=5" alt="image du jeu" class="sizeup"></a></div>
                <article>
                    <div>
                        <a href="./descriptionJeu.php"><h3>Titre du jeu</h3></a>
                        <a href="#" class="sizeup">Ajouter à votre liste</a>
